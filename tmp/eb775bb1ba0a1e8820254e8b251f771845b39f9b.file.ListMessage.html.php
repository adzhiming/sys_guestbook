<?php /* Smarty version Smarty-3.0.8, created on 2018-04-11 02:52:21
         compiled from "F:\xammp\htdocs\sys_guestbook/tpl\admin/message/ListMessage.html" */ ?>
<?php /*%%SmartyHeaderCode:249585acd7865249975-23504270%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'eb775bb1ba0a1e8820254e8b251f771845b39f9b' => 
    array (
      0 => 'F:\\xammp\\htdocs\\sys_guestbook/tpl\\admin/message/ListMessage.html',
      1 => 1523415122,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '249585acd7865249975-23504270',
  'function' => 
  array (
  ),
	...
	<div class="content">
		<div>
			...
			<form name="form1" action="" method="post"
				...
				<input type="text" placeholder="来源URL(支持模糊查询)" value="<?php echo $_smarty_tpl->getVariable('url')->value;?>
"
					name="url" class="url_input" />
				<div class="form-group">
					<label for="exampleInputName2">开始时间</label> <input name="stime"
						id="stime" type="date" value="<?php echo $_smarty_tpl->getVariable('stime')->value;?>
" class="form-control" />
				</div>
				<div class="form-group">
					<label for="exampleInputEmail2">结束时间</label> <input name="etime"
						id="etime" class="form-control" type="date" value="<?php echo $_smarty_tpl->getVariable('etime')->value;?>
" />
				</div>
				...
				<select name="pageSize" class="pull-right form-control pages"
					onchange="submit()">
					<option value="10"<?php if ($_smarty_tpl->getVariable('pageSize')->value=='10'){?>selected <?php }?>>10</option>
					<option value="20"<?php if ($_smarty_tpl->getVariable('pageSize')->value=='20'){?>selected <?php }?>>20</option>
					<option value="50"<?php if ($_smarty_tpl->getVariable('pageSize')->value=='50'){?>selected <?php }?>>50</option>
				</select>
...
(<?php echo $_smarty_tpl->tpl_vars['m']->value['ip'];?>
					...
					<td align="center"><?php echo $_smarty_tpl->tpl_vars['m']->value['message'];?>
</td>
					<td align="center"  class="remark" data-id="<?php echo $_smarty_tpl->tpl_vars['m']->value['id'];?>
"><?php echo $_smarty_tpl->tpl_vars['m']->value['remark'];?>
</td>
					<td class="right" align="center"><a
						class="btn btn-danger btn-xs new_mess_a"
						href="javascript:void(0);"
						onclick="delconfirm('id','<?php echo $_smarty_tpl->tpl_vars['m']->value['id'];?>
','确定删除(ID:<?php echo $_smarty_tpl->tpl_vars['m']->value['id'];?>
)的留言吗？');">
							删除单个留言</a> <a class="btn btn-danger btn-xs new_mess_a"
						href="javascript:void(0);"
						onclick="delconfirm('ip','<?php echo $_smarty_tpl->tpl_vars['m']->value['ip'];?>
...
条）：
							...
							<?php }?> <?php if (($_smarty_tpl->getVariable('start_page')->value+$_smarty_tpl->getVariable('max_page')->value)<=$_smarty_tpl->getVariable('pager')->value['total_page']){?>
							<?php $_smarty_tpl->tpl_vars['end_page'] = new Smarty_variable($_smarty_tpl->getVariable('start_page')->value+$_smarty_tpl->getVariable('max_page')->value-1, null, null);?> <?php }else{ ?>
							<?php $_smarty_tpl->tpl_vars['end_page'] = new Smarty_variable($_smarty_tpl->getVariable('pager')->value['total_page'], null, null);?> <?php }?> <?php if ($_smarty_tpl->getVariable('start_page')->value<=1&&$_smarty_tpl->getVariable('pager')->value['current_page']<=1){?> <a class="Invalid">首页</a> <a
								class="Invalid">上一页</a> <?php }elseif($_smarty_tpl->getVariable('pager')->value['current_page']>1&&$_smarty_tpl->getVariable('pager')->value['total_page']<=$_smarty_tpl->getVariable('max_page')->value){?> <a
								href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['spUrl'][0][0]->__template_spUrl(array('c'=>$_smarty_tpl->getVariable('c')->value,'a'=>$_smarty_tpl->getVariable('a')->value,'gid'=>$_smarty_tpl->getVariable('g')->value['id'],'page'=>$_smarty_tpl->getVariable('pager')->value['first_page'],'pageSize'=>$_smarty_tpl->getVariable('pageSize')->value,'stime'=>$_smarty_tpl->getVariable('stime')->value,'etime'=>$_smarty_tpl->getVariable('etime')->value,'url'=>$_smarty_tpl->getVariable('url')->value),$_smarty_tpl);?>
">首页</a>
							<a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['spUrl'][0][0]->__template_spUrl(array('c'=>$_smarty_tpl->getVariable('c')->value,'a'=>$_smarty_tpl->getVariable('a')->value,'gid'=>$_smarty_tpl->getVariable('g')->value['id'],'page'=>$_smarty_tpl->getVariable('pager')->value['prev_page'],'pageSize'=>$_smarty_tpl->getVariable('pageSize')->value,'stime'=>$_smarty_tpl->getVariable('stime')->value,'etime'=>$_smarty_tpl->getVariable('etime')->value,'url'=>$_smarty_tpl->getVariable('url')->value),$_smarty_tpl);?>
">上一页</a>
							<?php }elseif($_smarty_tpl->getVariable('pager')->value['current_page']>1&&$_smarty_tpl->getVariable('pager')->value['current_page']<=$_smarty_tpl->getVariable('max_page')->value){?> <a
								href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['spUrl'][0][0]->__template_spUrl(array('c'=>$_smarty_tpl->getVariable('c')->value,'a'=>$_smarty_tpl->getVariable('a')->value,'gid'=>$_smarty_tpl->getVariable('g')->value['id'],'page'=>$_smarty_tpl->getVariable('pager')->value['first_page'],'pageSize'=>$_smarty_tpl->getVariable('pageSize')->value,'stime'=>$_smarty_tpl->getVariable('stime')->value,'etime'=>$_smarty_tpl->getVariable('etime')->value,'url'=>$_smarty_tpl->getVariable('url')->value),$_smarty_tpl);?>
">首页</a>
							<a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['spUrl'][0][0]->__template_spUrl(array('c'=>$_smarty_tpl->getVariable('c')->value,'a'=>$_smarty_tpl->getVariable('a')->value,'gid'=>$_smarty_tpl->getVariable('g')->value['id'],'page'=>$_smarty_tpl->getVariable('pager')->value['prev_page'],'pageSize'=>$_smarty_tpl->getVariable('pageSize')->value,'stime'=>$_smarty_tpl->getVariable('stime')->value,'etime'=>$_smarty_tpl->getVariable('etime')->value,'url'=>$_smarty_tpl->getVariable('url')->value),$_smarty_tpl);?>
">上一页</a>
...
">«</a>
							<a
								href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['spUrl'][0][0]->__template_spUrl(array('c'=>$_smarty_tpl->getVariable('c')->value,'a'=>$_smarty_tpl->getVariable('a')->value,'gid'=>$_smarty_tpl->getVariable('g')->value['id'],'page'=>$_smarty_tpl->getVariable('pager')->value['current_page']-$_smarty_tpl->getVariable('max_page')->value,'pageSize'=>$_smarty_tpl->getVariable('pageSize')->value,'stime'=>$_smarty_tpl->getVariable('stime')->value,'etime'=>$_smarty_tpl->getVariable('etime')->value,'url'=>$_smarty_tpl->getVariable('url')->value),$_smarty_tpl);?>
...
?> <?php if ($_smarty_tpl->tpl_vars['thepage']->value<=$_smarty_tpl->getVariable('end_page')->value&&$_smarty_tpl->tpl_vars['thepage']->value>=$_smarty_tpl->getVariable('start_page')->value){?> <?php if ($_smarty_tpl->tpl_vars['thepage']->value==$_smarty_tpl->getVariable('pager')->value['current_page']){?> <a class="present"><?php echo $_smarty_tpl->tpl_vars['thepage']->value;?>
</a>
							<?php }else{ ?> <a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['spUrl'][0][0]->__template_spUrl(array('c'=>$_smarty_tpl->getVariable('c')->value,'a'=>$_smarty_tpl->getVariable('a')->value,'gid'=>$_smarty_tpl->getVariable('g')->value['id'],'page'=>$_smarty_tpl->tpl_vars['thepage']->value,'pageSize'=>$_smarty_tpl->getVariable('pageSize')->value,'stime'=>$_smarty_tpl->getVariable('stime')->value,'etime'=>$_smarty_tpl->getVariable('etime')->value,'url'=>$_smarty_tpl->getVariable('url')->value),$_smarty_tpl);?>
"><?php echo $_smarty_tpl->tpl_vars['thepage']->value;?>
</a>
							<?php }?> <?php }?> <?php }} ?> <?php if ($_smarty_tpl->getVariable('end_page')->value==$_smarty_tpl->getVariable('pager')->value['total_page']){?> <?php if ($_smarty_tpl->getVariable('pager')->value['current_page']==$_smarty_tpl->getVariable('pager')->value['last_page']){?> <a
								class="Invalid">下一页</a> <a class="Invalid">尾页</a> <?php }else{ ?> <a
								href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['spUrl'][0][0]->__template_spUrl(array('c'=>$_smarty_tpl->getVariable('c')->value,'a'=>$_smarty_tpl->getVariable('a')->value,'gid'=>$_smarty_tpl->getVariable('g')->value['id'],'page'=>$_smarty_tpl->getVariable('pager')->value['next_page'],'pageSize'=>$_smarty_tpl->getVariable('pageSize')->value,'stime'=>$_smarty_tpl->getVariable('stime')->value,'etime'=>$_smarty_tpl->getVariable('etime')->value,'url'=>$_smarty_tpl->getVariable('url')->value),$_smarty_tpl);?>
">下一页</a>
							<a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['spUrl'][0][0]->__template_spUrl(array('c'=>$_smarty_tpl->getVariable('c')->value,'a'=>$_smarty_tpl->getVariable('a')->value,'gid'=>$_smarty_tpl->getVariable('g')->value['id'],'page'=>$_smarty_tpl->getVariable('pager')->value['last_page'],'pageSize'=>$_smarty_tpl->getVariable('pageSize')->value,'stime'=>$_smarty_tpl->getVariable('stime')->value,'etime'=>$_smarty_tpl->getVariable('etime')->value,'url'=>$_smarty_tpl->getVariable('url')->value),$_smarty_tpl);?>
">尾页</a>
							<?php }?> <?php }else{ ?> <a
								href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['spUrl'][0][0]->__template_spUrl(array('c'=>$_smarty_tpl->getVariable('c')->value,'a'=>$_smarty_tpl->getVariable('a')->value,'gid'=>$_smarty_tpl->getVariable('g')->value['id'],'page'=>$_smarty_tpl->getVariable('pager')->value['current_page']+$_smarty_tpl->getVariable('max_page')->value,'pageSize'=>$_smarty_tpl->getVariable('pageSize')->value,'stime'=>$_smarty_tpl->getVariable('stime')->value,'etime'=>$_smarty_tpl->getVariable('etime')->value,'url'=>$_smarty_tpl->getVariable('url')->value),$_smarty_tpl);?>
">+<?php echo $_smarty_tpl->getVariable('max_page')->value;?>
			...
			$(this).children("input").eq(0).blur(function(){
				...
				if (newtxt != txt) {
					td.html(newtxt);
					 ...
					 //数据库的修改就在一般处理程序中完成 
					 $.post(url,{mid:messageid,remark:newtxt,gid:"<?php echo $_smarty_tpl->getVariable('gid')->value;?>
"}, function(data) { 
					 if(data=="1") 
					 { 
