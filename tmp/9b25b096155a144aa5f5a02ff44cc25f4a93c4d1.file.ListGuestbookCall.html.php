<?php /* Smarty version Smarty-3.0.8, created on 2018-03-26 03:11:36
         compiled from "F:\xammp\htdocs\sys_guestbook/tpl\admin/guestbookCall/ListGuestbookCall.html" */ ?>
<?php /*%%SmartyHeaderCode:73515ab864e85b66e5-22637609%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9b25b096155a144aa5f5a02ff44cc25f4a93c4d1' => 
    array (
      0 => 'F:\\xammp\\htdocs\\sys_guestbook/tpl\\admin/guestbookCall/ListGuestbookCall.html',
      1 => 1522033888,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '73515ab864e85b66e5-22637609',
  'function' => 
  array (
  ),
...
&quot;&gt;&lt;/script&gt;</pre>
        ...
        <thead>
          <tr>
            <th width="240"><span class="glyphicon glyphicon-cog" aria-hidden="true"></span> 接口调用:</th>
          </tr>
        </thead>
        <tbody>
          <tr>
            ...
            <pre>接口请求地址：<?php echo $_smarty_tpl->getVariable('url')->value;?>
?c=guestbook&amp;a=api_message_add&amp;gid=<?php echo $_smarty_tpl->getVariable('guestbook')->value['id'];?>
<br></>参数说明：gid=<?php echo $_smarty_tpl->getVariable('guestbook')->value['id'];?>
,name（用户名）,nick（昵称）,phone（电话号码）,message（留言内容）
            </pre>
            <p>优点：跨平台调用</p>
            <p>缺点：需要自己开发模板</p>
            <p class="text-danger">注意事项：出现乱码的的话要注意把（charset=UTF-8）改为你网站的编码。例如你要调用留言板的网站编码是GBK，则要改为“charset=GBK”</p>
